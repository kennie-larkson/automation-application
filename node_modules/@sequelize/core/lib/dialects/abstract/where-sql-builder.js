    ...
    return this.#handleRecursiveNotOrAndNestedPathRecursive(
      ...
      (left, operator, right) => {
        ...
        if (operator == null) {
          ...
          operator = Array.isArray(right) && !(leftDataType instanceof DataTypes.ARRAY) ? import_operators.Op.in : right === null || right === import_literal.SQL_NULL ? import_operators.Op.is : import_operators.Op.eq;
        }
        if (right === null && !(leftDataType instanceof DataTypes.JSON)) {
