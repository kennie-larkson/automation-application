...
export declare class SqliteQueryInterface extends AbstractQueryInterface {
    #private;
    readonly queryGenerator: SqliteQueryGenerator;
    constructor(sequelize: Sequelize, queryGenerator: SqliteQueryGenerator, internalQueryInterface?: SqliteQueryInterfaceInternal);
